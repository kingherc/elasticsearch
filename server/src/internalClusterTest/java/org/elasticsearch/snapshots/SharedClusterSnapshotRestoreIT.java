...
public class SharedClusterSnapshotRestoreIT extends AbstractSnapshotIntegTestCase {
    ...
    private void doConcurrentRates(ByteSizeValue rateLimit, List<ByteSizeValue> blockSizes) throws Exception {
        ...
        List<InputStream> inputStreams = new ArrayList<>(blockSizes.size());
        ...
        for (int i = 0; i < blockSizes.size(); i++) {
            writeInputToNull(threadPool, inputStreams.get(i), blockSizes.get(i), msRuntimeCounters.get(i), countdownLatch);
        }
